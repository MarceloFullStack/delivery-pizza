...
$sel=mysqli_query($db,"INSERT INTO store (opcionais_1, ingredientes_todos1, borda, quant_sabores, sessao, produto_id, pizza, tamanho, ingredientes1, sabores1, data, status, quantidade, valor, ids_pizzas) VALUES ('$opcionais1', '$ing_todos1', '$borda', '$numero', '$pedido', '$idpizza', 'sim', '$tamanho', '$ingredi1', '".$fatia1[0]."', '".date('d/m/y')."', '0', '1', '$xvalor', '$ids')");
