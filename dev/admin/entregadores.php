...
$(document).ready(function(){
	...
	$("#flex1").flexigrid
			...
			url: 'entregadores_ajax.php',
			dataType: 'json',
			colModel : [
				{display: 'ID', name : 'id', width : 30, sortable : true, align: 'center'},
				{display: 'Nome', name : 'nome_casal', width : 250, sortable : true, align: 'left'},
				{display: 'Telefone', name : 'id_us', width : 120, sortable : true, align: 'left'},
				{display: 'Endereço', name : 'id_us', width : 350, sortable : true, align: 'left'},
				{display: 'Editar', name : 'id_us', width : 50, sortable : true, align: 'center', process: procMe},
				{display: 'Remover', name : 'id_us', width : 50, sortable : true, align: 'center', process: procDel}
				],
			buttons : [
...
function procMe( celDiv, id ) {
    $( celDiv ).click( function() {
       window.location='editar_entregador.php?id='+id;	
    });
}
...
$.post('delete_entregador.php', {id: id}, function(resposta) {
...
<div class="box_1">
  ...
  <div class="box_21">
      ...
      <div class="box_14"><img src="arquivos/Desktop.png" width="32" height="32" />
          <h5>Entregadores Cadastrados</h5>
      </div>
