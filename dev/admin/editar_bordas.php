...
$("#enviar").click(function() {
  ...
  $.post('envia_editar_borda.php', {id: id, categoria: categoria, taxa: taxa}, function(resposta) {																																																																																
              ...
              <tr>
                ...
                <td colspan="2" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="56%"><strong>Taxa</strong></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
               
                <td width="372" valign="bottom"><input value="<?php echo $categ['nome'] ?>" name="nome" style="padding:15px; background-color:#FFFFFF; border: #B6B6B6 solid 1px; color:#666666; font-weight:bold; font-size: 14px;" type="text" id="categoria" size="35" /></td>
                <td width="478" valign="bottom"><input value="<?php echo $categ['taxa'] ?>" name="taxa" style="padding:15px; background-color:#FFFFFF; border: #B6B6B6 solid 1px; color:#666666; font-weight:bold; font-size: 14px;" type="text" id="taxa" size="10" /></td>
              </tr>
              <tr>
                <td height="95" colspan="3"><div style="padding-top:5px; padding-bottom:5px; padding:15px; padding-right:15px; background-color: #005391; color: #FFFFFF; font-weight: bold; border: 1px solid #004578; width: 100px; text-align: center; cursor: pointer;" id="enviar">Enviar</div>                  
                  </td>
              </tr>
            </table>
          </form>
