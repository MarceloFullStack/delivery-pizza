...
if(confirm("Tem certeza que deseja apagar este Bairro?"))
{
  ...
  <div class="box_21">
      ...
      <div class="box_15">
        ...
        <div class="box200">
          ...
          <div class="box207">Nome do Bairro<input  name="nome" type="text" id="categoria" /></div>
          <div class="box206">Taxa<input  name="taxa" type="text" id="taxa" /></div>
          <div class="box206">Tempo<input  name="tempo" type="text" id="tempo"/></div>
...
<a href="editar_bairro.php?id=<?php echo $categ['id'] ?>"><div class="box_104a"></div></a>
