...
$("#enviar").click(function() {
  ...
  $.post('envia_sabores.php', {extra: extra, categoria: categoria}, function(resposta) {																																																																																
...
<div class="box_1">
  ...
  <div class="box_21">
      ...
      <div class="box_285">
        <div class="box_287">
    <div class="box_289a">Sabor<input type="text" placeholder="Bacon, Calabresa..." name="textfield3" id="categoria" /></div>
    <div class="box_291a">Ingredientes Extras?<select name="fatias" id="extra">
    ...
    <div class="box_14"><img src="arquivos/Desktop.png" width="32" height="32" />
        ...
        <div style="float:left; width:100%">
          <div class="box_15">
            <div class="box_22">
        <?php
		$cat=mysqli_query($db,"SELECT * FROM sabores");
        ...
        <tr>
        <td height="35" valign="middle"><?php echo $categ['sabor'] ?></td>
        </tr>
        </table>
        </div>
        <a href="editar_sabor.php?id=<?php echo $categ['id'] ?>"><div class="box_104a"></div></a>
