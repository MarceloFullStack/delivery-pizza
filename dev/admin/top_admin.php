...
<div class="box_4"><div class="box_5">
    <!-- <div class="box_41"><div class="box_41a"><img src="/admin/logo/<?php echo $config['logomarca']; ?>" /> -->
    <div class="box_41"><div class="box_41a"><h3 style="color: white;padding:5px;">MarceloDeveloper</h3>
  </div>
  </div>
  </div>
      <div class="box_6">
