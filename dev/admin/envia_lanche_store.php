...
$stor  = mysqli_query($db,"SELECT * FROM store WHERE sessao='$pedido' and produto_id='".$produto['id']."' order by id desc");
$store = mysqli_fetch_assoc($stor);
...
$sel=mysqli_query($db,"INSERT INTO store (sessao, produto_id, lanche, lanche_id, data, status, valor, quantidade, ingredientes) VALUES ('$pedido', '".$produto['id']."', 'sim', '".$produto['id']."', '".date('d-m-Y')."', '0', '".$produto['valor']."', '1', '$ingredientes')");
