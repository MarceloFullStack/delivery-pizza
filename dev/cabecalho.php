  ...
  <div class="box2">
    <div class="box4">
      <div class="box174 menu-anchor">
        <div class="box175">
          <div class="box179">
            <div class="box177"></div>
            <div class="box178"></div>
          </div>
          <div class="box179">
            <div class="box177"></div>
            <div class="box178"></div>
      ...
      <div class="box15 shopping-cart">
          ...
          <div class="box61">
            <ul id="carrinho_p">
              <?php while ($itens = mysqli_fetch_assoc($item)) { ?>
                <?php
                if ($itens['pizza'] <> 'sim') {
                  $bebidas = mysqli_query($db, "SELECT * FROM produtos WHERE id='" . $itens['produto_id'] . "'");
                ...
                ?>
                  <li class="li-<?php echo $itens['id'] ?>">
                    <div class="carrinho0"><img src="/fotos_produtos/<?php echo $bebida['foto']; ?>" width="25" height="25" /></div>
                    <div class="carrinho1"><span><?php echo $nome; ?></span></div>
                    <div class="carrinho2"><span class="remove" id="<?php echo $itens['id'] ?>" data-xvalor="<?php echo $itens['valor'] ?>"></span><a id="<?php echo $itens['id'] ?>" class="maisum" data-mvalor="<?php echo $itens['valor'] ?>"></a><input id="inpu-<?php echo $itens['id'] ?>" type="text" class="in-qtdd-item-ped" readonly="on" value="<?php echo $itens['quantidade'] ?>"><a id="<?php echo $itens['id'] ?>" data-nvalor="<?php echo $itens['valor'] ?>" class="menosum"></a></div>
                  </li>
                ...
                <?php } else { ?>
                  ...
                  <li class="li-<?php echo $itens['id'] ?>">
                    <div class="carrinho0"><img src="/arquivos/pizza-ilustrativa2.jpg" width="25" height="25"></div>
                    <div class="carrinho1"><span>
                        <p><?php echo $itens['tamanho'] ?></p><i><?php echo $itens['sabores1'] ?>

                          <?php if ($itens['sabores2'] <> '') {
                            echo ' + ' . $itens['sabores2'] . '';
                          } ?>
        ...
        <div class="box21">
          ...
          <?php if (!isset($_SESSION['id_usu_pizza'])) {  ?><a href="/checkout"><?php } else { ?><a href="/finalizar"><?php } ?><div class="box23">Fechar Pedido</div></a>
              ...
              <a href="/carrinho.php" id="manual-ajax">
