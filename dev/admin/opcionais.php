...
?>
<div class="box34u" id="ingredientes_opcionais" data-opcionais="<?php echo $_POST['opcionais'] ?>">
  <div class="box35u">Ingredientes opcionais</div>
  <div class="box36u"><?php echo $produtos['tamanho']; ?> - Sabor <?php echo $produtos['sabor']; ?></div>
<div class="box213u">  
...
$(document).ready(function() {
		...
		if($(this).prop('checked')) {
		   $('.ingredientes-'+sabor).append('<li class="box2035 nome-'+id+'">'+nome+' + R$'+valor+'<input type="checkbox" id="nome-'+id+'" checked="checked" name="opcionais-'+sabor+'[]" value="'+nome+'" class="switch-input" /></li>');
		 $('.ingredientes-'+sabor).scrollTop($('.ingredientes-'+sabor)[0].scrollHeight);
		
		
		 $.post('add_opcionais.php', {id_usuario: id_usuario, nome: nome, ingrediente: id, valor: valor, sabor: sabor});
			    ...
			    setTimeout(function () {
			    $.post('sessao_valor_total.php', {id_usuario: id_usuario, valor1: valor01, valor2: valor02, valor3: valor03, valor4: valor04, valorborda: valorbo}, function(resposta) {
		 ...
		 $('.ingredientes-'+sabor+' input:checkbox[id="nome-'+id+'"]').removeAttr('checked');
         $.post('remove_opcionais.php', {id_usuario: id_usuario, nome: nome, ingrediente: id, valor: valor, sabor: sabor});
...
<?php if($ingrediente['valor']){ ?>
  <div class="box2032u nome-<?php echo $idl ?>" data-nomeopcional="<?php echo $idl ?>" data-valoropcional="<?php echo $ingrediente['valor'] ?>">
  ...
  <?php }else{ ?>
  <div class="box2034u"><div class="box2033">
