  ...
  <div class="box_21">
      ...
      <table id="datatable-buttons" class="table table-striped table-bordered bulk_action">
                     ...
                     <thead>
                      ...
                      <?php
					  $dado=mysqli_query($db,"SELECT * FROM usuarios order by id_u"); while($dados=mysqli_fetch_assoc($dado)){
					  ?>
                        <tr>
                          ...
                          <td><div align="center"><img src="editar.png" border="0" /></div></td>
                          <td><div align="center"><img src="lixeira.png" border="0" /></div></td>
                        </tr>
                       <?php } ?>
                      </tbody>
                    </table>
                ...
                },
                {
				...
				
				 {
				  ...
				  action: function ( e, dt, node, config ) {
					...
					$.post('delete_empresas.php', {files: files}, function(resposta) {
